          ...
          <div className='flex'>
            <div className='flex-shrink-0 flex items-center '>
              <Link to='/'>
                ...
                <span className='perpetua italic tracking-wide text-yellow-500'>
                  educare
                </span>
              </Link>
            </div>
          ...
          <div className='hidden md:block'>
            <div className='ml-10 flex items-baseline'>
              <ul className='flex text-lg m-2 py-2'>
                ...
                <li>
                  <button className='text-lg bg-transparent hover:text-black text-white font-semibold py-2 px-2 rounded mr-2 transition-transform duration-300 hover:scale-110'>
                    About Us
                  </button>
                </li>
                <li>
